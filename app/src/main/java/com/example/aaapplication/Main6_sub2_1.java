...
public class Main6_sub2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main6_sub2_1);
        ...
        btn_start = (Button) findViewById(R.id.main6_sub2_1_start);
        rel_front = (RelativeLayout)findViewById(R.id.main6_sub2_front);
        rel_behind = (RelativeLayout)findViewById(R.id.main6_sub2_behind);
        ...
        //        设置 隐藏视频自带暂停开始健
        MediaController mediaCtlr = new MediaController(Main6_sub2_1.this);
        ...
        countDownTimer = new CountDownTimer(4000, 1000) {
            ...
            public void onFinish() {
                if(countDownTimer != null) {
                    // 倒计时完成时触发
                    Intent intent = new Intent(Main6_sub2_1.this, Main6_sub2_2.class);
...
//        结束测试按钮
        ...
        main6_sub2_1_exist.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Main6_sub2_1.this,Main6_age7_18.class);
                intent.putExtra("student", student);
                startActivity(intent);
                finish();
            }
