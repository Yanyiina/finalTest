...
public class Main5_sub2_2 extends AppCompatActivity {
    ...
    private TextView main5_sub2_2_exist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //        自动播放视频
        //读取放在 raw 目录下的文件
        videoView = (VideoView) findViewById(R.id.main5_sub2_2_videoView);
        videoView.setVideoURI(Uri.parse("android.resource://com.example.aaapplication/" + R.raw.main5_zhicheng));
        videoView.setMediaController(new MediaController(this));

        //        设置 隐藏视频自带暂停开始健
        MediaController mediaCtlr = new MediaController(Main5_sub2_2.this);
...
//        结束测试按钮
        main5_sub2_2_exist = (TextView)findViewById(R.id.main5_sub2_2_exist);
        main5_sub2_2_exist.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        //        倒计时
        progressBar = findViewById(R.id.main5_sub2_progressBar);
        countdownText = findViewById(R.id.main5_sub2_countdownText);
        //        正计时
        elapsedTimeText = findViewById(R.id.main5_sub2_elapsedTimeText);
