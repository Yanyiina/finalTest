...
public class Main5_sub3_1 extends AppCompatActivity {
    ...
    private TextView main5_sub3_1_exist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_start = (Button) findViewById(R.id.main5_sub3_1_start);
        rel_front = (RelativeLayout)findViewById(R.id.main5_sub3_front);
        rel_behind = (RelativeLayout)findViewById(R.id.main5_sub3_behind);
        ...
        //        设置 隐藏视频自带暂停开始健
        MediaController mediaCtlr = new MediaController(Main5_sub3_1.this);
...
//        倒计时
        timeText = findViewById(R.id.main5_sub3_time);
...
//        结束测试按钮
        main5_sub3_1_exist = (TextView)findViewById(R.id.main5_sub3_1_exist);
        main5_sub3_1_exist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (countDownTimer != null) {
