...
public class Main6_sub6_1 extends AppCompatActivity {
    ...
    private TextView main6_sub6_1_exist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rel_front = (RelativeLayout)findViewById(R.id.main6_sub6_1_front);
        rel_behind = (RelativeLayout)findViewById(R.id.main6_sub6_1_behind);
        ...
        //        设置 隐藏视频自带暂停开始健
        MediaController mediaCtlr = new MediaController(Main6_sub6_1.this);
...
//        倒计时
        timeText = findViewById(R.id.main6_sub6_1_time);
...
//        结束测试按钮
        main6_sub6_1_exist = (TextView)findViewById(R.id.main6_sub6_1_exist);
        main6_sub6_1_exist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (countDownTimer != null) {
