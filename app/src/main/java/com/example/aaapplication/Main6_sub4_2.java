...
public class Main6_sub4_2 extends AppCompatActivity {
    ...
    private TextView main6_sub4_2_exist;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main6_sub4_2);
        ...
        //        自动播放视频
        //读取放在 raw 目录下的文件
        videoView = (VideoView) findViewById(R.id.main6_sub4_2_videoView);
        videoView.setVideoURI(Uri.parse("android.resource://com.example.aaapplication/" + R.raw.main6_30s));
        videoView.setMediaController(new MediaController(this));

        //        设置 隐藏视频自带暂停开始健
        MediaController mediaCtlr = new MediaController(Main6_sub4_2.this);
...
//        结束测试按钮
        main6_sub4_2_exist = (TextView)findViewById(R.id.main6_sub4_2_exist);
        main6_sub4_2_exist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Main6_sub4_2.this,Main6_age7_18.class);
        ...
        //        倒计时
        progressBar = findViewById(R.id.main6_sub4_progressBar);
        countdownText = findViewById(R.id.main6_sub4_countdownText);
        //        正计时
        elapsedTimeText = findViewById(R.id.main6_sub4_elapsedTimeText);
...
//                int progress = (int) ((totalTime - timeRemaining) * progressMax / totalTime);
    ...
    private void navigateToAnotherActivity(List_stu student) {
        Intent intent = new Intent(Main6_sub4_2.this, Main6_sub4_3.class);
        intent.putExtra("student", student);
        startActivity(intent);
        finish(); // 结束当前页面
    }
